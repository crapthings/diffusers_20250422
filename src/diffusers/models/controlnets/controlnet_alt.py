...
class ControlNetModelAlt(ModelMixin, ConfigMixin, FromOriginalModelMixin):
    """
    A ControlNet model.
    ...
    def __init__(
        ...
        self.control_alpha_scale = nn.Parameter(torch.tensor(1.0)) # 初始值为 1.0
        self.control_beta_scale = nn.Parameter(torch.tensor(1.0))  # 初始值为 1.0
    ...
    def forward(
        ...
        if learnable_control_scale is True:
            alpha = self.control_alpha_scale 
            beta = self.control_beta_scale
        else:
