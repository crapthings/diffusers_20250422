...
try:
    ...
    _import_structure["pipeline_pag_controlnet_sd_xl_alt"] = ["StableDiffusionXLControlNetPAGPipelineAlt"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    try:
        ...
        from .pipeline_pag_controlnet_sd_xl_alt import StableDiffusionXLControlNetPAGPipelineAlt
